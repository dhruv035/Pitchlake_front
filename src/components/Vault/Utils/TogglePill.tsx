...
import { VaultUserRole } from "@/lib/types";
    ...
    <div className="inline-flex rounded-md p-1 bg-[#0D0D0D] border border-[#262626]">
      <button
        className={`flex items-center px-4 py-2 rounded transition-colors duration-200 ease-in-out ${
          vaultUser === VaultUserRole.Provider
            ? "bg-[#373632] text-[#F5EBB8]"
            : "text-gray-300 hover:text-white"
        }`}
        onClick={() => setVaultUserType(VaultUserRole.Provider)}
      >
      ...
      <button
        className={`flex items-center px-4 py-2 rounded transition-colors duration-200 ease-in-out ${
          vaultUser === VaultUserRole.Buyer
            ? "bg-[#373632] text-[#F5EBB8]"
            : "text-gray-300 hover:text-white"
        }`}
        onClick={() => setVaultUserType(VaultUserRole.Buyer)}
      >
