...
const useOptionRoundState = (address: string | undefined) => {
  ...
  const {
    ...
    useMemo(() => ({
      contractData,
      watch: true,  // Assuming you want to keep this dynamic update active
      states: [
        { functionName: "get_vault_address", key: "vaultAddress" },
        { functionName: "get_round_id", key: "roundId" },
        { functionName: "get_state", key: "roundState" },
        { functionName: "get_deployment_date", key: "deploymentDate" },
        { functionName: "get_auction_start_date", key: "auctionStartDate" },
        { functionName: "get_auction_end_date", key: "auctionEndDate" },
        { functionName: "get_option_settlement_date", key: "optionSettleDate" },
        { functionName: "get_starting_liquidity", key: "startingLiquidity" },
        { functionName: "get_sold_liquidity", key: "soldLiquidity" },
        { functionName: "get_unsold_liquidity", key: "unsoldLiquidity" },
        { functionName: "get_reserve_price", key: "reservePrice" },
        { functionName: "get_strike_price", key: "strikePrice" },
        { functionName: "get_cap_level", key: "capLevel" },
        { functionName: "get_options_available", key: "availableOptions" },
        { functionName: "get_options_sold", key: "optionsSold" },
        { functionName: "get_clearing_price", key: "clearingPrice" },
        { functionName: "get_total_premium", key: "premiums" },
        { functionName: "get_settlement_price", key: "settlementPrice" },
        { functionName: "get_total_payout", key: "totalPayout" },
      ],
    }), [contractData])
  );
  ...
  const {
    ...
    useMemo(() => ({
      contractData,
      states: [
        { functionName: "get_bid_tree_nonce", key: "treeNonce" },
        {
